...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Out-2022 às 21:18
...
(1, 'Mercado', '#6b2a39', 'despesa', 1, 'ativo'),
...
(7, 'Dividendos', '#5a6045', 'receita', 1, 'ativo'),
...
(3, 'weslley', 'simões', 'weslley_silvas@hotmail.com', '1998-04-19', 'masculino', '$2y$10$Y6ARms8GcehJiHgCvJxIG.vA6KR.OnaZ9t6wcrzuIS35m3UuVsgW2', 'ABERTO', NULL),
(4, 'maria', 'souza', 'maria@teste.com', '1986-05-19', 'feminino', '$2y$10$c57lzgbXQammPLlZM4HJ7eVJ9fk2C/lK23SVFKEeVaVLbw6pripmi', 'ABERTO', NULL);

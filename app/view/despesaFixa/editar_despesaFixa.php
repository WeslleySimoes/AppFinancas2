...
<div class="container-form">
    ...
    <form action="<?= HOME_URL ?>/despesa/editarFP?id=<?= $_GET['id'] ?>&t=<?= $_GET['t'] ?>" method="POST">

        <label for="despesaRecebida" class="checkbox-container">
            <input type="checkbox" name="despesaRecebida" value="1" class="checkboxForm" <?= $dadosEdicao[0]->status_desp == 'fechado' ? 'checked' : '' ?>>

...
class Receita extends BaseController
{
    ...
    public function cadastrar()
    {
        ...
        try {
            ...
            $dados['listaCategorias'] = CategoriaModel::findBy("id_usuario = ".UsuarioSession::get('id')." and tipo = 'receita'");
        ...
        if(!empty($_POST) and isset($_POST['valor']))
        {
            ...
            if($v->validar())
            {
                ...
                try {
                    ...
                    $ts->data_trans = $_POST['dataReceita'];
    ...
    //=========================================================================================
    // MÉTODO REPONSÁVEL POR EDITAR RECEITA FIXA
    //=========================================================================================
